...
(function (Format) {
    ...
    Format[Format["TIMESTAMP"] = 1] = "TIMESTAMP";
    Format[Format["SRT"] = 2] = "SRT";
})(Format || (Format = {}));
let formatStrings = [
    "Text Only",
    "With Timestamps",
...
function SpeechRecognizer(props) {
    ...
    const [isRecoding, setRecording] = react_1.useState(false);
    const [step, setStep] = react_1.useState(0);
    const [startAt, setStartAt] = react_1.useState(0);
    const [format, setFormat] = react_1.useState(Format.PLAIN);
    const [lang, setLang] = react_1.useState("");
    // const [records, setRecords] = useState<SpeechRecord[]>([]);
    const [currentResults, setCurrentResults] = react_1.useState([]);
    const onRecordStart = () => __awaiter(this, void 0, void 0, function* () {
        const mediaRecorder = yield utils_1.createMediaRecorder({
            onData(chunks) {
    ...
    const onRecordEnd = () => __awaiter(this, void 0, void 0, function* () {
    ...
    react_1.useEffect(() => {
        ...
        let recognition = utils_1.createSpeechRecognition({
            lang: lang,
            onResult(results) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("select", { onChange: onLangChange }, langs.map((x) => react_1.default.createElement("option", { key: x.label, value: x.value }, x.label))),
        isRecoding ? (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement("button", { onClick: onRecordEnd }, "recording end"),
            "\u00A0 Recording...")) : (react_1.default.createElement("button", { onClick: onRecordStart }, "recording start")),
        react_1.default.createElement("hr", null),
        react_1.default.createElement("h3", null, "Output"),
        currentResults.length > 0 && react_1.default.createElement("div", null, "Input..."),
        currentResults.map((r, index) => {
            return (react_1.default.createElement("div", { key: index },
                Math.floor(r.confidence * 10000) / 100,
                "%: ",
                r.transcript,
                ":"));
        }),
        react_1.default.createElement("textarea", { ref: textareaRef, placeholder: "Press start to record...", readOnly: isRecoding, style: { width: "95vw", height: "60vh" }, value: speechText, onChange: () => { } }),
        react_1.default.createElement("div", null,
            react_1.default.createElement("select", { onChange: onFormatChange }, formats.map((x) => react_1.default.createElement("option", { key: x, value: x }, formatStrings[x]))))));
}
exports.SpeechRecognizer = SpeechRecognizer;
function zeroPaddingMax3(num, length) {
...
function recordToTranscript(r) {
    return r.results.map(i => i.transcript).join(". ");
}
function recordsToString(records, startAt, format) {
    var result = "";
    var count = 1;
...
Object.defineProperty(exports, "__esModule", { value: true });
const react_1 = __importStar(__webpack_require__(/*! react */ "./node_modules/react/index.js"));
const SpeechRecognizer_1 = __webpack_require__(/*! ./SpeechRecognizer */ "./src/SpeechRecognizer.tsx");
exports.App = () => {
    const media = react_1.useRef(null);
    const [blobURL, setBlobURL] = react_1.useState("");
    const [records, setRecords] = react_1.useState();
    const blobUpdated = react_1.useCallback(function (blob, records) {
        if (media.current) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(SpeechRecognizer_1.SpeechRecognizer, { onBlobUpdated: blobUpdated }),
        react_1.default.createElement("div", { style: blobURL == "" ? { display: "none" } : { display: "block" } },
            react_1.default.createElement("audio", { ref: media, controls: !0 }))));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.SpeechRecognition = global.webkitSpeechRecognition || global.SpeechRecognition;
// let currentRecognition: SpeechRecogintion | null = null;
function createSpeechRecognition(opts) {
    const recognition = new exports.SpeechRecognition();
    recognition.lang = opts.lang || "ja-JP";
    recognition.interimResults = true;
    let currentInputResults = [];
    ...
    let start = null;
    let end = null;
    recognition.onspeechstart = (_event) => {
        // set at init
        if (start == null) {
            start = Date.now();
        }
    ...
    recognition.onspeechend = (_event) => {
        end = Date.now();
        console.log("SpeechRecognition: onspeechend");
    };
    recognition.onnomatch = (_event) => {
...
function createMediaRecorder(listeners) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        recorder.addEventListener("stop", () => __awaiter(this, void 0, void 0, function* () {
